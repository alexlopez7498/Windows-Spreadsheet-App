// <copyright file="DivideNode.cs" company="Alex Lopez-Garcia">
...
{
    /// <summary>
    /// Divide Node which inherits the operator Node.
    /// </summary>
    internal class DivideNode : OperatorNode
    {
        ...
        /// <summary>
        /// override Evaluate method which divides the childs.
        /// </summary>
        /// <returns>The sum of the childs.</returns>
